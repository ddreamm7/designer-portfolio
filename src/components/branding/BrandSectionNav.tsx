...
export default function BrandSectionNav({ kinds }: { kinds: string[] }) {
  ...
  return (
    <nav className="sticky top-[72px] z-20 -mx-6 border-y border-border bg-background/80 px-6 py-5 backdrop-blur-md md:mx-0 md:top-[64px] md:px-0">
