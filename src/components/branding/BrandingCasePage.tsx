...
import type { BrandingProject } from "@/data/projects";
import FadeInView from "@/components/FadeInView";
import BrandAssetGrid from "./BrandAssetGrid";
import BrandSectionNav from "./BrandSectionNav";
...
function groupByKind(gallery: BrandingProject["gallery"]) {
...
export default function BrandingCasePage({ project }: { project: BrandingProject }) {
